...
outdir = f"/glurch/home/kic04594/hadrana/src/hadrana/misc/lhpc/plots/{ensemble}/POLZ_CURZ"
    ...
    for it, t in enumerate(ts):
        ...
        for row, src_id in enumerate(src_ids_to_plot):
            ...
            for col, (label, ratios, source_set) in enumerate([
                ...
                if col == 0:
                    ax.set_ylabel(r"$\mathrm{Im}\,R_A^{z,z}(\mathbf{q}, t, \tau)$")

                ax.legend()

    filepath = f"{outdir}/{ensemble}-ISOVECTOR-AXIAL-RATIOS-LHP-REG-POLZ-CURZ-MOM-{qtag}.pdf"
