...
from hadrana.fits.fits_c2pt.timeslice_criteria import (
...
def perform_c2pt_two_state_fit(
    ...
    two_state_cost = CorrelatedChi2(
        model   = model_c2pt_ratio_two_state,
        x_data  = fit_range,
...
def perform_c2pt_one_state_fit(
    ...
    one_state_cost = CorrelatedChi2(
        model = model_c2pt_ratio_one_state,
        x_data = fit_range,
        y_data = c2pt_jkn_avg[fit_range],
        cov_inv = cov_inv
    )
